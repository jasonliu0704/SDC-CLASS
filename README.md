...
This project aims to detect and classify object on a roadgraph scene. For perception system, we need to first detection object and localize object in order for the downstream pipeline to run segmentation, classification and tracking.
...
python download_process.py --data_dir data/waymo --temp_dir data
...
python create_splits.py --data_dir /home/workspace/waymo/data/
...
python inference_video.py --labelmap_path label_map.pbtxt --model_path training/experiment0/exported_model/saved_model --tf_record_path /home/workspace/data/waymo/test/segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord --config_path training/experiment0/pipeline_new.config --output_path animation.mp4
...
This is waymo open data set in tf records format with the below schema
...
applied k fold cross validation where I split data in the k buckets and run k times, each time use k-1 bucks for training and 1 for validation.
...
you can see my output at animation.mp4
# SDC-CLASS
